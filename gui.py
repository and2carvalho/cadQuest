...
class AddQuestao ( wx.Frame ):
	...
	def __init__( self, parent, tipo_questao_suportado ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"PyFeed - Unicesumar EAD", pos = wx.DefaultPosition, size = wx.Size( 771,680 ), style = wx.DEFAULT_FRAME_STYLE|wx.STAY_ON_TOP|wx.TAB_TRAVERSAL )
		...
		self.cb_atv1 = wx.CheckBox( self, wx.ID_ANY, u"Mapa", wx.DefaultPosition, wx.DefaultSize, 0 )
