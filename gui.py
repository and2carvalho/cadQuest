...
class Login(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"PyFeed - Unicesumar EAD", pos=wx.DefaultPosition,
                          size=wx.Size(290, 325), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)

        self.SetSizeHints(wx.Size(290, 325), wx.Size(290, 325))
        ...
        self.m = wx.StaticBitmap(sbSizerLogo.GetStaticBox(), wx.ID_ANY,
                                 wx.Bitmap(u"static/logoCesumar.png", wx.BITMAP_TYPE_ANY), wx.DefaultPosition,
                                 wx.Size(-1, -1), 0)
        ...
        self.txt_senha = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(250, -1),
                                     wx.TE_PASSWORD)
...
class AddQuestao(wx.Frame):
    ...
    def __init__(self, parent, tipo_questao_suportado):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"PyFeed - Unicesumar EAD", pos=wx.DefaultPosition,
                          size=wx.Size(670, 670), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        self.lb_modulo.SetForegroundColour(wx.Colour(255, 255, 255))
        ...
        self.lb_curso.SetForegroundColour(wx.Colour(255, 255, 255))

        bSizer8.Add(self.lb_curso, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        cb_cursoChoices = [u"TEO", u"TEOL", u"AGRO", u"CCONT", u"GPUB", u"ENG. PROD.", u"ENG. SOFT.", u"EDU", u"GRH",
                           u"ADS", u"SI", u"DM", u"DI", u"ADM", u"PGER", u"MKT", u"MAT", u"HIST", u"SEG. TRAB.", u"PED",
                           u"GAMB", u"GEO", u"T.I", u"GPV", u"GFIN", u"GASTRO", u"GCOM", u"GIMOB", u"LET", u"LOG",
                           u"SEC", u"GH", u"DP", u"SSOC", u"GC", u"GQ", u"GTS", u"ECON", u"CURSO DE ORIGEM", u"EMP",
                           u"BEDU", u"ECIV", u"EELE", u"EMEC", u"EMCA", u"HEPROD", u"HÍBRIDO", u"FSCE",
                           u"PROJETO DE ENSINO", u"SPRIV", u"ARTV", u"CBIO", u"PSICO", u"PCERV", u"SALI", u"FIL",
                           u"SOCIO", u"ECOS", u"POD", u"TINT"]
        self.cb_curso = wx.ComboBox(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                    cb_cursoChoices, 0)
        ...
        self.lb_origem.SetForegroundColour(wx.Colour(255, 255, 255))
        ...
        self.lb_disciplina.SetForegroundColour(wx.Colour(255, 255, 255))
        ...
        self.lb_diretorioRaiz.SetForegroundColour(wx.Colour(255, 255, 255))
        ...
        self.lb_tipoQuestao.SetForegroundColour(wx.Colour(255, 255, 255))

        bSizer10.Add(self.lb_tipoQuestao, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        cb_tipoQuestaoChoices = tipo_questao_suportado
        self.cb_tipoQuestao = wx.ComboBox(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                          cb_tipoQuestaoChoices, 0)
        ...
        self.lb_complexidade.SetForegroundColour(wx.Colour(255, 255, 255))
        ...
        self.lb_atividade.SetForegroundColour(wx.Colour(255, 255, 255))
        ...
        self.cb_unLivro = wx.RadioBox(self, wx.ID_ANY, u"Unidade do Livro", wx.DefaultPosition, wx.DefaultSize,
        ...
        self.lb_enunciado = wx.StaticText(self, wx.ID_ANY, u"Texto Base / Enunciado", wx.DefaultPosition,
                                          wx.DefaultSize, 0)
        self.lb_enunciado.Wrap(-1)
        self.lb_enunciado.SetForegroundColour(wx.Colour(255, 255, 255))

        bSizer12.Add(self.lb_enunciado, 0, wx.ALL, 5)

        self.tx_enunciado = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(500, 250),
                                        wx.TE_MULTILINE)
        ...
        self.lb_resposta.SetForegroundColour(wx.Colour(255, 255, 255))

        bSizer12.Add(self.lb_resposta, 0, wx.ALL, 5)

        self.tx_resposta = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(500, 100),
                                       wx.TE_MULTILINE)
        bSizer12.Add(self.tx_resposta, 0, wx.ALL | wx.EXPAND, 5)

        bSizer6.Add(bSizer12, 0, wx.EXPAND, 5)

        self.bt_salvarQuestao = wx.Button(self, wx.ID_ANY, u"Salvar Nova Questão", wx.DefaultPosition, wx.DefaultSize,
                                          0)
...
class PyFeed(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.img_logo = wx.StaticBitmap(sbSizerLogo.GetStaticBox(), wx.ID_ANY,
                                        wx.Bitmap(u"static/logoCesumar.png", wx.BITMAP_TYPE_ANY), wx.DefaultPosition,
                                        wx.DefaultSize, 0)
        ...
        self.lb_main.SetFont(
            wx.Font(wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL,
                    False, "Hack"))
        self.lb_main.SetForegroundColour(wx.Colour(255, 255, 255))
        ...
        self.btn_novaQuestao = wx.BitmapButton(self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.Size(60, 50),
                                               wx.BU_AUTODRAW | 0)
        ...
        self.btn_configEstrutura = wx.BitmapButton(self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.Size(60, 40),
                                                   wx.BU_AUTODRAW | 0)
        ...
        self.btn_confereQuestao = wx.BitmapButton(self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.Size(60, 40),
                                                  wx.BU_AUTODRAW | 0)
        ...
        self.btn_configApp = wx.BitmapButton(self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.Size(60, 50),
                                             wx.BU_AUTODRAW | 0)
...
class AlternativaCorreta(wx.Dialog):
    ...
    def __init__(self, parent, alternativas):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"Finaliza Estrutura Banco de Questoes",
                           pos=wx.DefaultPosition, size=wx.Size(269, 290), style=wx.DEFAULT_DIALOG_STYLE)
        ...
        self.lb_alt_correta = wx.StaticText(self, wx.ID_ANY, u"Selecione a alternativa correta", wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        self.lb_alt_correta.Wrap(-1)

        self.lb_alt_correta.SetFont(
            wx.Font(wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL,
                    False, wx.EmptyString))
        self.lb_alt_correta.SetForegroundColour(wx.Colour(255, 255, 255))

        bSizer5.Add(self.lb_alt_correta, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.TOP, 12)

        rb_alt_corretaChoices = alternativas
        self.rb_alt_correta = wx.RadioBox(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                          rb_alt_corretaChoices, 1, wx.RA_SPECIFY_COLS)
        self.rb_alt_correta.SetSelection(0)
        bSizer5.Add(self.rb_alt_correta, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, 12)

        bSizer16 = wx.BoxSizer(wx.VERTICAL)

        self.bt_alt_correta = wx.Button(self, wx.ID_ANY, u"Selecionar e cadastrar estrutura", wx.DefaultPosition,
                                        wx.DefaultSize, 0)
...
class AlternativaTag(wx.Dialog):
    ...
    def __init__(self, parent, alternativas):
        ...
        cb_cursoChoices = ["TEO", "TEOL", "AGRO", "CCONT", "GPUB", "ENG. PROD.", "ENG. SOFT.", "EDU", "GRH", "ADS",
                           "SI", "DM", "DI", "ADM", "PGER", "MKT", "MAT", "HIST", "SEG. TRAB.", "PED", "GAMB", "GEO",
                           "T.I", "GPV", "GFIN", "GASTRO", "GCOM", "GIMOB", "LET", "LOG", "SEC", "GH", "DP", "SSOC",
                           "GC", "GQ", "GTS", "ECON", "CURSO DE ORIGEM", "EMP", "BEDU", "ECIV", "EELE", "EMEC", "EMCA",
                           "HEPROD", "HÍBRIDO", "FSCE", "PROJETO DE ENSINO", "SPRIV", "ARTV", "CBIO", "PSICO", "PCERV",
                           "SALI", "FIL", "SOCIO", "ECOS", "POD", "TINT"]
        self.cb_curso = wx.ComboBox(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                    cb_cursoChoices, 0)
        ...
        cb_unLivroChoices = [u"Cap. I", u"Cap. II", u"Cap. III", u"Cap. IV", u"Cap. V", u"Cap. VI", u"Cap. VII",
                             u"Cap. VIII", u"Cap. IX"]
        self.cb_unLivro = wx.RadioBox(self, wx.ID_ANY, u"Und. Livro", wx.DefaultPosition, wx.DefaultSize,
                                      cb_unLivroChoices, 3, wx.RA_SPECIFY_ROWS)
        self.cb_unLivro.SetSelection(0)
        ...
        self.bt_alt_tag = wx.Button(self, wx.ID_ANY, u"Selecionar e cadastrar estrutura", wx.DefaultPosition,
                                    wx.DefaultSize, 0)
