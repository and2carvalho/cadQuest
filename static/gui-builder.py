...
class Login ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"PyFeed - Unicesumar EAD", pos = wx.DefaultPosition, size = wx.Size( 298,350 ), style = wx.DEFAULT_FRAME_STYLE|wx.STAY_ON_TOP|wx.TAB_TRAVERSAL )
...
class AddQuestao ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"PyFeed - Unicesumar EAD", pos = wx.DefaultPosition, size = wx.Size( 771,731 ), style = wx.DEFAULT_FRAME_STYLE|wx.STAY_ON_TOP|wx.TAB_TRAVERSAL )
		...
		bSizer8.Add( self.cb_curso, 1, wx.ALL, 5 )
		...
		self.cb_mapa.SetForegroundColour( wx.Colour( 229, 229, 229 ) )
		...
		self.cb_unLivro.SetSelection( 3 )
		...
		bSizer11.Add( self.lb_destino, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		bSizer11.Add( self.cb_destinoProva, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		bSizer11.Add( self.cb_destinoAtv, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
...
class AlternativaCorreta ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		rb_alt_corretaChoices = [ wx.EmptyString ]
...
class AlternativaTag ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText21.SetForegroundColour( wx.Colour( 229, 229, 229 ) )
		...
		self.m_staticText23.SetForegroundColour( wx.Colour( 229, 229, 229 ) )
